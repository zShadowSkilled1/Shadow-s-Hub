...
if suc and type(web) ~= "boolean" then
    ...
    if game.GameId == 2619619496 then
        ...
        if game.PlaceId == 6872265039 then
            ...
            local sprint = addModule("Sprint", "Automatically sprint.", function(callback)
                if callback then
                    task.spawn(function()
                        repeat
                            task.wait()
            ...
            local reachfunc
            local reach = addModule("Reach", "Gives you 4 studs of reach.", function(callback)
                if callback then
            ...
            local killaurafunc
            local killaura = addModule("Killaura", "Hits enemy without aiming at them.", function(callback)
                if callback then
